...
export default function ArticlesPage() {
  return <main className={styles.shell}>
    ...
    <section className={styles.grid} aria-label="Ferramentas gratuitas">
      <article className={styles.card}><Link href="/tarot-do-amor-gratis" className={styles.cardImage}><img src="/assets/tarot/cards/enamorados.webp" alt="Tarot do Amor grátis com três cartas" /></Link><div className={styles.cardBody}><span>Ferramenta grátis</span><h2><Link href="/tarot-do-amor-gratis">Tarot do Amor Grátis · tire 3 cartas</Link></h2><p>Faça uma pergunta amorosa, escolha três cartas e veja sua leitura sem cadastro e sem pagamento.</p><Link href="/tarot-do-amor-gratis" className={styles.readLink}>Fazer tiragem <b>→</b></Link></div></article>
      <article className={styles.card}><Link href="/mapa-astral-gratis" className={styles.cardImage}><img src="/assets/tarot/cards/estrela.webp" alt="Mapa Astral grátis online" /></Link><div className={styles.cardBody}><span>Ferramenta grátis</span><h2><Link href="/mapa-astral-gratis">Mapa Astral Grátis Online</Link></h2><p>Descubra Sol, Lua, planetas pessoais e Ascendente quando houver horário de nascimento confiável.</p><Link href="/mapa-astral-gratis" className={styles.readLink}>Calcular mapa <b>→</b></Link></div></article>
    </section>
